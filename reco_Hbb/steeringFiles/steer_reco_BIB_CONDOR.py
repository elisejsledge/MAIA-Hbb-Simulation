...
read.Files = ["/scratch/ejsledge/jetStudies/sim_Hbb/sim_mumu_H_bb_10TeV_0.slcio"] ##change input file
algList.append(read)
...
MyAIDAProcessor.Parameters = {
    "FileName": ["lctuple_Hbb_mumu_10_TeV_1"], #change file name
    "FileType": ["root"]
}
...
Output_REC.Parameters = {
    ...
    "LCIOOutputFile": ["HBB_reco_mumu_10TeV_1.slcio"], #change output file 2
...
InitDD4hep.Parameters = {
    "DD4hepXMLFile": ["/scratch/ejsledge/detector-simulation/geometries/MuColl_10TeV_v0A/MuColl_10TeV_v0A.xml"], #change geo location
...
MyEcalBarrelSelector.Parameters = {
    ...
    "ThresholdsFilePath": ["/opt/MyBIBUtils/data/ECAL_Thresholds_10TeV.root"], #change location of this file
    "Nsigma": ["0"],
...
#    "MuonEndCapBField": ["5.0"],
    ...
    "PandoraSettingsXmlFile": ["/scratch/ejsledge/jetStudies/reco_Hbb/PandoraSettings/PandoraSettingsDefault.xml"], #change xml location
